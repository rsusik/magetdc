&& q_size == 6 ) {
			SEARCH_FUNCTION_NAME<4, 3, 6, 90>();
		} else if( k == 3 && U == 4 && q_size == 7 ) {
			SEARCH_FUNCTION_NAME<4, 3, 7, 90>();
		} else if( k == 3 && U == 4 && q_size == 8 ) {
			SEARCH_FUNCTION_NAME<4, 3, 8, 90>();
		} else if( k == 3 && U == 4 && q_size == 9 ) {
			SEARCH_FUNCTION_NAME<4, 3, 9, 90>();
		} else if( k == 3 && U == 4 && q_size == 10 ) {
			SEARCH_FUNCTION_NAME<4, 3, 10, 90>();
		} else if( k == 3 && U == 8 && q_size == 1 ) {
			SEARCH_FUNCTION_NAME<8, 3, 1, 90>();
		} else if( k == 3 && U == 8 && q_size == 2 ) {
			SEARCH_FUNCTION_NAME<8, 3, 2, 90>();
		} else if( k == 3 && U == 8 && q_size == 3 ) {
			SEARCH_FUNCTION_NAME<8, 3, 3, 90>();
		} else if( k == 3 && U == 8 && q_size == 4 ) {
			SEARCH_FUNCTION_NAME<8, 3, 4, 90>();
		} else if( k == 3 && U == 8 && q_size == 5 ) {
			SEARCH_FUNCTION_NAME<8, 3, 5, 90>();
		} else if( k == 3 && U == 8 && q_size == 6 ) {
			SEARCH_FUNCTION_NAME<8, 3, 6, 90>();
		} else if( k == 3 && U == 8 && q_size == 7 ) {
			SEARCH_FUNCTION_NAME<8, 3, 7, 90>();
		} else if( k == 3 && U == 8 && q_size == 8 ) {
			SEARCH_FUNCTION_NAME<8, 3, 8, 90>();
		} else if( k == 3 && U == 8 && q_size == 9 ) {
			SEARCH_FUNCTION_NAME<8, 3, 9, 90>();
		} else if( k == 3 && U == 8 && q_size == 10 ) {
			SEARCH_FUNCTION_NAME<8, 3, 10, 90>();
		} else if( k == 4 && U == 4 && q_size == 1 ) {
...
template<class T> void EncodeText_wrapper(T * text, const int sigma, unsigned int q_gram, unsigned int u, unsigned int k) {
	if(sigma == 4) {
		...
		} else if(q_gram == 1 && u == 4 && k == 3) {
			EncodeText<T, 1, 4, 3, 4>(text);
		...
		} else if(q_gram == 1 && u == 8 && k == 3) {
			EncodeText<T, 1, 8, 3, 4>(text);
		...
		} else if(q_gram == 2 && u == 4 && k == 3) {
			EncodeText<T, 2, 4, 3, 4>(text);
		...
		} else if(q_gram == 2 && u == 8 && k == 3) {
			EncodeText<T, 2, 8, 3, 4>(text);
		...
		} else if(q_gram == 3 && u == 4 && k == 3) {
			EncodeText<T, 3, 4, 3, 4>(text);
		...
		} else if(q_gram == 3 && u == 8 && k == 3) {
			EncodeText<T, 3, 8, 3, 4>(text);
		...
		} else if(q_gram == 4 && u == 4 && k == 3) {
			EncodeText<T, 4, 4, 3, 4>(text);
		...
		} else if(q_gram == 4 && u == 8 && k == 3) {
			EncodeText<T, 4, 8, 3, 4>(text);
		...
		} else if(q_gram == 5 && u == 4 && k == 3) {
			EncodeText<T, 5, 4, 3, 4>(text);
		...
		} else if(q_gram == 5 && u == 8 && k == 3) {
			EncodeText<T, 5, 8, 3, 4>(text);
		...
		} else if(q_gram == 6 && u == 4 && k == 3) {
			EncodeText<T, 6, 4, 3, 4>(text);
		...
		} else if(q_gram == 6 && u == 8 && k == 3) {
			EncodeText<T, 6, 8, 3, 4>(text);
		...
		} else if(q_gram == 7 && u == 4 && k == 3) {
			EncodeText<T, 7, 4, 3, 4>(text);
		...
		} else if(q_gram == 7 && u == 8 && k == 3) {
			EncodeText<T, 7, 8, 3, 4>(text);
		...
		} else if(q_gram == 8 && u == 4 && k == 3) {
			EncodeText<T, 8, 4, 3, 4>(text);
		...
		} else if(q_gram == 8 && u == 8 && k == 3) {
			EncodeText<T, 8, 8, 3, 4>(text);
		...
		} else if(q_gram == 9 && u == 4 && k == 3) {
			EncodeText<T, 9, 4, 3, 4>(text);
		...
		} else if(q_gram == 9 && u == 8 && k == 3) {
			EncodeText<T, 9, 8, 3, 4>(text);
		...
		} else if(q_gram == 10 && u == 4 && k == 3) {
			EncodeText<T, 10, 4, 3, 4>(text);
		...
		} else if(q_gram == 10 && u == 8 && k == 3) {
			EncodeText<T, 10, 8, 3, 4>(text);
